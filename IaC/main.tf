...
#Storage Account for the Website Code
# resource "azurerm_storage_blob" "Website" {
#     name = "website"
#     storage_account_name = azurerm_storage_account.CloudResumeStorage.name
